...
import { Video, BarChart, Users, Sparkles } from 'lucide-react';
...
// Clean WhatsApp link without special chars for compatibility
...
// High-quality assets for Luxury Dubai Vibe
// Using reliable Unsplash IDs for images and Pexels HD video links
export const PORTFOLIO_ITEMS: PortfolioItem[] = [
  // --- REAL ESTATE ---
  {
    id: "re-1",
    type: "video",
    src: "https://videos.pexels.com/video-files/3209828/3209828-hd_1080_1920_25fps.mp4", // Modern apartment interior
  ...
  },
  {
    id: "re-2",
    type: "image",
    src: "https://images.unsplash.com/photo-1512453979798-5ea904ac6605?q=80&w=800&auto=format&fit=crop",
    alt: "Skyline View Villa",
    platform: "Instagram",
    industry: "Real Estate",
  ...
  },
  {
    ...
    details: "Fast-paced cut of a modern villa interior, synced to trending audio."
  },
  {
    id: "re-4",
    type: "image",
    src: "https://images.unsplash.com/photo-1600596542815-e32c630bd1ba?q=80&w=800&auto=format&fit=crop",
    alt: "Marble Bathroom Detail",
    platform: "Instagram",
    industry: "Real Estate",
  ...
  },
  {
    id: "fb-3",
    type: "video",
    src: "https://videos.pexels.com/video-files/4057317/4057317-uhd_2160_4096_25fps.mp4", // Coffee pouring
  ...
  // --- HOSPITALITY ---
  {
    id: "hosp-1",
    type: "video",
    src: "https://videos.pexels.com/video-files/3764258/3764258-hd_1080_1920_25fps.mp4", // Nightlife/Party
    alt: "VIP Lounge Night",
    platform: "Instagram",
  ...
  },
  {
    id: "hosp-2",
    type: "image",
    src: "https://images.unsplash.com/photo-1544675549-b59a685cb481?q=80&w=800&auto=format&fit=crop",
    alt: "Yacht Life",
    platform: "Instagram",
    industry: "Hospitality",
    stats: { views: "1.8M", likes: "95K" },
    details: "Aerial drone shot of a private yacht charter near the Burj Al Arab."
  },
  {
    id: "hosp-3",
    type: "video",
    src: "https://videos.pexels.com/video-files/5048666/5048666-hd_1080_1920_30fps.mp4", // Pool/Resort
    alt: "Infinity Pool Relax",
    platform: "TikTok",
    industry: "Hospitality",
    stats: { views: "2.2M", likes: "180K" },
    details: "POV relaxation video at a 5-star resort infinity pool."
  },
  {
    id: "hosp-4",
    type: "image",
    src: "https://images.unsplash.com/photo-1582719508461-905c673771fd?q=80&w=800&auto=format&fit=crop",
    alt: "Hotel Suite Luxury",
    platform: "Instagram",
    industry: "Hospitality",
    stats: { views: "600K", likes: "40K" },
    details: "Interior showcase of the presidential suite."
  },
  ...
  // --- FASHION ---
  {
    id: "fash-1",
    type: "video",
    src: "https://videos.pexels.com/video-files/6064973/6064973-hd_1080_1920_25fps.mp4", // Fashion model
  ...
  },
  {
    id: "fash-2",
    type: "image",
    src: "https://images.unsplash.com/photo-1582672060674-bc2bd808a8b5?q=80&w=800&auto=format&fit=crop",
    alt: "Street Style Gold Souk",
    platform: "Instagram",
    industry: "Fashion",
    stats: { views: "900K", likes: "75K" },
    details: "Edgy street style photography in the traditional Gold Souk."
  },
  {
    id: "fash-3",
    type: "video",
    src: "https://videos.pexels.com/video-files/5630685/5630685-hd_1080_1920_25fps.mp4", // Makeup/Beauty
    alt: "Luxury Beauty Reveal",
    platform: "Instagram",
    industry: "Fashion",
  ...
  },
  {
    ...
    alt: "Mall Fashion Run",
    platform: "Instagram",
    industry: "Fashion",
    stats: { views: "750K", likes: "55K" },
    details: "Shopping spree aesthetic at Dubai Mall Fashion Avenue."
  },
  ...
  // --- TECH ---
  {
    id: "tech-1",
    type: "video",
    src: "https://videos.pexels.com/video-files/3192305/3192305-hd_1080_1920_25fps.mp4", // Phone usage
    alt: "App Launch Demo",
    platform: "TikTok",
    industry: "Tech",
  ...
  },
  {
    ...
    details: "Aesthetic gaming setup tour with neon lighting."
  },
  {
    id: "tech-3",
    type: "video",
    src: "https://videos.pexels.com/video-files/8489704/8489704-hd_1080_1920_25fps.mp4", // VR/Futuristic
    alt: "VR Experience",
    platform: "TikTok",
    industry: "Tech",
  ...
  },
  {
    ...
    details: "Minimalist workspace setup for productivity influencers."
  }
];
